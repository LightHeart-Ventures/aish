...
This guide covers installing aish on **Ubuntu 22.04 LTS** (Jammy Jellyfish).
...
#### "error: linker error: undefined reference to `__glibc_...`"
This is a known issue with openssl/native-tls on some Ubuntu 22.04 systems. The release binary is pre-built and doesn't have this issue:

```bash
# Use the pre-built release instead of building locally
# Download from: https://github.com/LightHeart-Ventures/aish/releases
curl -L https://github.com/LightHeart-Ventures/aish/releases/download/v0.14.0/aish-x86_64-unknown-linux-gnu \
  -o ~/.local/bin/aish
...
| Requirement | Ubuntu 22.04 | Notes |
|---|---|---|
| **OS** | ✅ | Tested on 22.04 LTS; 20.04 / 24.04 also work |
...
| **glibc** | 2.35+ | Ubuntu 22.04 has 2.35 (rustls TLS library compatible) |
| **TLS** | OpenSSL 3.0 | Ubuntu 22.04 ships 3.0 (compatible; aish uses rustls) |
